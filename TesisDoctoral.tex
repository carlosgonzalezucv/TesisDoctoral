...
%
%\usepackage{amssymb,verbatim,enumerate,ifthen,graphics,graphicx,amsmath,amsthm}
%\usepackage{showkeys}
%\usepackage{multicol}
%\usepackage{amsfonts}
...
%\usepackage[right=3cm,left=3cm,top=3cm,bottom=2.5cm,headsep=0cm,footskip=0.5cm]{geometry}
